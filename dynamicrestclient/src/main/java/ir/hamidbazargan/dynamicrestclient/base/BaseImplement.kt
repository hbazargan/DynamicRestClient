...
import ir.hamidbazargan.dynamicrestclient.request.HttpRequestMethods
import ir.hamidbazargan.dynamicrestclient.request.RequestBuilderImplement
import ir.hamidbazargan.dynamicrestclient.client.ClientImplement
...
internal class BaseImplement(
    ...
    val restClient: ApiInterface
        get() = client.getRestClient(baseUrl)
